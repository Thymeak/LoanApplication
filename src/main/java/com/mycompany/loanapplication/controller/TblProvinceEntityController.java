...
import com.mycompany.loanapplication.service.TblProvinceEntityFacade;
...
@Named("tblProvinceEntityController")
@SessionScoped
public class TblProvinceEntityController implements Serializable {

    @EJB
    private com.mycompany.loanapplication.service.TblProvinceEntityFacade ejbFacade;
    private List<TblProvinceEntity> items = null;
    private TblProvinceEntity selected;

    public TblProvinceEntityController() {
    }
    ...
    private TblProvinceEntityFacade getFacade() {
        return ejbFacade;
    }
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("TblProvinceEntityCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("TblProvinceEntityUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("TblProvinceEntityDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public static class TblProvinceEntityControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            TblProvinceEntityController controller = (TblProvinceEntityController) facesContext.getApplication().getELResolver().
